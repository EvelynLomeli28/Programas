import 'package:app2_unidad4/basededatoshelper/basededatoshelper.dart';
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () async{
                 await Basedatoshelper().modificar(id, usuarionuevo.text, passwordnuevo.text);
                 cargarDatos();
            ...
            return ListTile(
              ...
              trailing: Wrap(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed:(){ 
                      _modificar(usuarios[index]['id'],usuarios[index]['usuario'],usuarios[index]['password']);
                      }, 
